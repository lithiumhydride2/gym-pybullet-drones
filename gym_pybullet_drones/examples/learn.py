...
DEFAULT_ACT = ActionType(
    'one_d_rpm')  # 'rpm' or 'pid' or 'vel' or 'one_d_rpm' or 'one_d_pid'
DEFAULT_AGENTS = 2
DEFAULT_MA = True
...
def run(multiagent=DEFAULT_MA,
    ...
    model.learn(
        ...
        if local else int(1e2),  # shorter training in GitHub Actions pytest
    ...
    if not multiagent:
        ...
        test_env = MultiHoverAviary(gui=gui,
                                    ...
                                    act=DEFAULT_ACT,
                                    record=record_video)
        test_env_nogui = MultiHoverAviary(num_drones=DEFAULT_AGENTS,
                                          obs=DEFAULT_OBS,
                                          act=DEFAULT_ACT)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str2bool,
        help=
        'Whether to use example LeaderFollower instead of Hover (default: False)',
        metavar='')
